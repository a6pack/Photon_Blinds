...
metadata {
  ...
  definition (name:"Photon Blind Controller - V4.0", namespace:"a6pack/Photon_Blinds", author:"Brian Anderson") {
    capability "Actuator"
...
//			}
   ...
   standardTile("switch", "device.switch", width: 2, height: 2, canChangeIcon: false) {
    ...
    main(["switch"])
    details(["status", "tiltup", "tiltdown","refresh", "levelSliderControl", "photoresistor"])
  }
}
